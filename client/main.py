...
print(requests.post(f'http://localhost:5000/simulations/{simulacaoId}/job/0/operation/0',
      headers={"Authorization": f"Bearer {token}"},
      json={'machine': 0, 'duration': 3}).text)
print(requests.post(f'http://localhost:5000/simulations/{simulacaoId}/job/0/operation/1',
      headers={"Authorization": f"Bearer {token}"},
      json={'machine': 1, 'duration': 2}).text)
print(requests.post(f'http://localhost:5000/simulations/{simulacaoId}/job/0/operation/2',
      headers={"Authorization": f"Bearer {token}"},
      json={'machine': 2, 'duration': 2}).text)

print(requests.post(f'http://localhost:5000/simulations/{simulacaoId}/job/1/operation/0',
      headers={"Authorization": f"Bearer {token}"},
      json={'machine': 0, 'duration': 2}).text)
print(requests.post(f'http://localhost:5000/simulations/{simulacaoId}/job/1/operation/2',
      headers={"Authorization": f"Bearer {token}"},
      json={'machine': 1, 'duration': 4}).text)
print(requests.post(f'http://localhost:5000/simulations/{simulacaoId}/job/1/operation/1',
      headers={"Authorization": f"Bearer {token}"},
      json={'machine': 2, 'duration': 1}).text)

print(requests.post(f'http://localhost:5000/simulations/{simulacaoId}/job/2/operation/2',
      headers={"Authorization": f"Bearer {token}"},
      json={'machine': 0, 'duration': 2}).text)
print(requests.post(f'http://localhost:5000/simulations/{simulacaoId}/job/2/operation/0',
      headers={"Authorization": f"Bearer {token}"},
      json={'machine': 1, 'duration': 4}).text)
print(requests.post(f'http://localhost:5000/simulations/{simulacaoId}/job/2/operation/1',
      headers={"Authorization": f"Bearer {token}"},
      json={'machine': 2, 'duration': 3}).text)

# get operation
print(requests.get(f'http://localhost:5000/simulations/{simulacaoId}/job/2/operation/2',
      headers={"Authorization": f"Bearer {token}"}).text)


# check table
print(requests.get(f'http://localhost:5000/simulations/{simulacaoId}/checkTable',
      headers={"Authorization": f"Bearer {token}"}).text)


# get table
print(requests.get(
    f'http://localhost:5000/simulations/{simulacaoId}/table',
    headers={"Authorization": f"Bearer {token}"}).text)


# adicionar operação plano produção
print(requests.post(
    f'http://localhost:5000/simulations/{simulacaoId}/job/0/operation/0/initTime/0',
    headers={"Authorization": f"Bearer {token}"}).text)

print(requests.post(
    f'http://localhost:5000/simulations/{simulacaoId}/job/0/operation/2/initTime/5',
    headers={"Authorization": f"Bearer {token}"}).text)
print(requests.post(
    f'http://localhost:5000/simulations/{simulacaoId}/job/0/operation/1/initTime/3',
    headers={"Authorization": f"Bearer {token}"}).text)


print(requests.post(
    f'http://localhost:5000/simulations/{simulacaoId}/job/1/operation/1/initTime/7',
    headers={"Authorization": f"Bearer {token}"}).text)

print(requests.post(
    f'http://localhost:5000/simulations/{simulacaoId}/job/1/operation/0/initTime/3',
    headers={"Authorization": f"Bearer {token}"}).text)

print(requests.post(
    f'http://localhost:5000/simulations/{simulacaoId}/job/1/operation/2/initTime/8',
    headers={"Authorization": f"Bearer {token}"}).text)


print(requests.post(
    f'http://localhost:5000/simulations/{simulacaoId}/job/2/operation/0/initTime/13',
    headers={"Authorization": f"Bearer {token}"}).text)

print(requests.post(
    f'http://localhost:5000/simulations/{simulacaoId}/job/2/operation/1/initTime/17',
    headers={"Authorization": f"Bearer {token}"}).text)

print(requests.post(
    f'http://localhost:5000/simulations/{simulacaoId}/job/2/operation/2/initTime/20',
    headers={"Authorization": f"Bearer {token}"}).text)


# check table
print('checkTable: ' + requests.get(
    f'http://localhost:5000/simulations/{simulacaoId}/planoProducao/check',
    headers={"Authorization": f"Bearer {token}"}).text)


print(requests.get(
    f'http://localhost:5000/simulations/{simulacaoId}/planoProducao/maxTime',
    headers={"Authorization": f"Bearer {token}"}).text)
